...
{
    /// <summary>
    /// Example of how we could override the regionmanager to allow navigation to ribbons. Bear in mind the ideal solution is to do this overriding the navigation service so the journal can navigate back.
