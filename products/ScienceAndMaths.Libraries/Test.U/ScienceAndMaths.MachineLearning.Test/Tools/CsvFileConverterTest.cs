...
namespace ScienceAndMaths.MachineLearning.Test.Tools
{
    ...
    public class CsvFileConverterTest
    {
        ...
        public void Test()
        {
            ...
            CsvFileConverter.ConvertCsvToCsv(@"D:\CURSOS\ABDATACHALLENGE\BBDD y DataSet ejemplo\Datos demográficos INE\renta.csv", @"D:\CURSOS\ABDATACHALLENGE\BBDD y DataSet ejemplo\Datos demográficos INE\incomes.csv", new List<int> { 0, 1 });
        }
    }
}
